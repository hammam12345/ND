...
message.channel.send({embed});
  ...
  client.on('message', async msg => { // eslint-disable-line
	...
	if (!msg.content.startsWith(ND)) return undefined;
...
```
|NDplay لتشغيل اغنية
|NDpause لإيقاف اغنية مؤقتا
|NDresume لإستئناف الاغنية
|NDvol للتحكم في درجة الصوت
|NDjoin لدخول البوت في الروم
|NDstop لإيقاف الاغنية
```
